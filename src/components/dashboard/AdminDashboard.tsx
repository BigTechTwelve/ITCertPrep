...
import { Users, Box, Award, Target, BookOpen, Activity, ArrowRight, ShieldCheck, UserCog, BarChart3, TrendingUp, Settings, Sparkles } from 'lucide-react';
...
export default function AdminDashboard() {
    const [activeView, setActiveView] = useState<'overview' | 'pathways' | 'certifications' | 'objectives' | 'questions' | 'users' | 'settings'>('overview');
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                if (data) setAnalyticsData(data as AnalyticsData[]);
    ...
    const maxUsers = Math.max(...analyticsData.map(d => d.new_users), 1);
    const maxQuizzes = Math.max(...analyticsData.map(d => d.quizzes_completed), 1);
        ...
        <>
            <div className="space-y-10 fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="group relative bg-white dark:bg-slate-900 rounded-[32px] p-8 shadow-premium border border-white dark:border-slate-800 overflow-hidden hover:scale-[1.02] transition-transform duration-300">
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-slate-500 font-medium">Manage roles, permissions, and accounts</p>
                                </div>
                            </div>
                            <div className="h-10 w-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:text-indigo-600 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-900/20 transition-colors">
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-slate-500 font-medium">Define learning tracks and roadmaps</p>
                                </div>
                            </div>
                            <div className="h-10 w-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:text-violet-600 group-hover:bg-violet-50 dark:group-hover:bg-violet-900/20 transition-colors">
                                <ArrowRight className="h-5 w-5" />
                            </div>
                        </button>
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-slate-500 font-medium">Manage exams, domains, and questions</p>
                                </div>
                            </div>
                            <div className="h-10 w-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:text-emerald-600 group-hover:bg-emerald-50 dark:group-hover:bg-emerald-900/20 transition-colors">
                                <ArrowRight className="h-5 w-5" />
                            </div>
                        </button>
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-slate-500 font-medium">Global feature toggles and configuration</p>
                                </div>
                            </div>
                            <div className="h-10 w-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:text-indigo-600 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-900/20 transition-colors">
                                <ArrowRight className="h-5 w-5" />
